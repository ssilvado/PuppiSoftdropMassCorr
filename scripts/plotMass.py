...
setmax = 0.39
prefix = '/mnt/t3nfs01/data01/shome/thaarres/EXOVVAnalysisRunII/AnalysisOutput/76X/'
addBKG = False
doFit = True
...
files = [ 
        "ExoDiBosonAnalysis.BulkWW_13TeV_1000GeV.VV.root",
        "ExoDiBosonAnalysis.BulkZZ_13TeV_1000GeV.VV.root",
        "ExoDiBosonAnalysis.RadionZZ_13TeV_1000GeV.VV.root",
        ...
        "ExoDiBosonAnalysis.RadionZZ_13TeV_4000GeV.VV.root",
...
legendname = [ "W (G_{Bulk}#rightarrow WW (Madgraph))",
               ...
               "Z (Radion#rightarrow ZZ (Madgraph))",   
